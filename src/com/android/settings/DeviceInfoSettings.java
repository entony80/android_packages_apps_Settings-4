...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private static final String KEY_CYANPOP_VERSION = "cyanpop_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_CYANPOP_VERSION, "ro.cyanpop.version");
        findPreference(KEY_CYANPOP_VERSION).setEnabled(true);
